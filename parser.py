...
exacta509 = open(os.path.join(os.getcwd(), 'InitialData', '506I-parada-loc-exacta.csv'), 'w')
estima509 = open(os.path.join(os.getcwd(), 'InitialData', '506I-parada-loc-estima.csv'), 'w')
