...
## EX: python loadData.py busstop InitialData/busstops.csv servicesbybusstop InitialData/servicesbybusstop.csv servicestopdistance InitialData/servicestopdistance.csv ServiceLocation InitialData/servicelocation.csv


log = open('loadDataError.log', 'w')
loadAllEvents = LoadEvents()
loadAllEvents.loadEvents()
ticks = [1000, 1000, 5000, 50000]
