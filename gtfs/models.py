...
class Location(models.Model):
    ...
    class Meta:
        """
        This makes that the fields here define are added to the tables that extends this, and no ForeignKey is
        made.
        """
        abstract = True
...
class ServicesByBusStop(models.Model):
    """
    This model helps to determine the direction of the bus service I or R. All of this is tied to the bus stop code and
    the service provided by it. It's useful to have the direction of the service to be able to determine position of
    the bus.
    """
    code = models.CharField(max_length=11, null=False, blank=False)  # EX: 506I, R and I indicate "Ida" and "Retorno"
...
class BusStop(Location):
    ...
    def get_dictionary(self):
        """
        useful information regarding the bus.
        """
...
class Service(models.Model):
    """
    Represent a route like '506' and save his data.
    """
...
class ServiceLocation(Location):
    """
    This models stores the position along the route of every bus at 20 meters apart. You can give the distance from the
    start of the travel and it return the position at that distance.
    """
...
class ServiceStopDistance(models.Model):
    """
    This model stores the distance for every bustop in every bus route for every service. Given a bus direction code
    xxxI or xxxR or something alike.
    """
