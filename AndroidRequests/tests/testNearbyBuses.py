...
class NearbyBusTest(TestCase):
    ...
    def test_nearbyBusesWithFakeAuthorityInfoWithOneUserBus(self):
        ...
        self.assertEqual(buses[4]['patente'], fakeJsonAuthorityAnswer['servicios'][4]['patente'])
        self.assertEqual(buses[5]['patente'], fakeJsonAuthorityAnswer['servicios'][5]['patente'])
        self.assertEqual(buses[6]['patente'], fakeJsonAuthorityAnswer['servicios'][6]['patente'])
        self.assertEqual(buses[7]['patente'], fakeJsonAuthorityAnswer['servicios'][7]['patente'])
        self.assertEqual(buses[8]['patente'], fakeJsonAuthorityAnswer['servicios'][8]['patente'])
        self.assertEqual(buses[9]['patente'], fakeJsonAuthorityAnswer['servicios'][9]['patente'])
    ...
    def test_nearbyBusesWithFakeAuthorityInfoWithTwoUserBus(self):
        ...
        self.assertEqual(buses[5]['patente'], fakeJsonAuthorityAnswer['servicios'][4]['patente'])
        self.assertEqual(buses[6]['patente'], fakeJsonAuthorityAnswer['servicios'][5]['patente'])
        self.assertEqual(buses[7]['patente'], fakeJsonAuthorityAnswer['servicios'][6]['patente'])
        self.assertEqual(buses[8]['patente'], fakeJsonAuthorityAnswer['servicios'][7]['patente'])
        self.assertEqual(buses[9]['patente'], fakeJsonAuthorityAnswer['servicios'][8]['patente'])
        self.assertEqual(buses[10]['patente'], fakeJsonAuthorityAnswer['servicios'][9]['patente'])
    ...
    def test_nearbyBusesWithFakeAuthorityInfoWithUserBusThatMatchWithAuthorityBus(self):
    ...
    def test_nearbyBusesFormatDistance(self):
        ...
        self.assertEqual(views.formatDistance(distanceGreaterThan1000NotInt), "1.86Km")
        self.assertEqual(views.formatDistance(distanceGreaterThan1000Int), "2Km")
    ...
    def test_nearbyBusesFormatTime(self):
        ...
        times = ["Menos de 5 min.", "Entre 19 Y 29 min.", "Mas de 45 min.", "En menos de 10 min.", "Otro caso"]
        distances = [50, 150]

        answers = ["Llegando", "0 a 5 min", "19 a 29 min", "19 a 29 min", "+ de 45 min", "+ de 45 min", "Llegando", "0 a 10 min", "Otro caso", "Otro caso"]
        index = 0
        for time in times:
            for distance in distances:
                self.assertEqual(views.formatTime(time, distance), answers[index])
                index += 1
